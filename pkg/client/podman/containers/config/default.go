...
import (
	...
	"github.com/silenium-dev/docker-wrapper/pkg/client/podman/containers/apparmor"
	...
	types2 "github.com/silenium-dev/docker-wrapper/pkg/client/podman/containers/types"
...
const (
	...
	DefaultLogSizeMax = -1
	// DefaultEventsLogSizeMax is the default value for the maximum events log size
	// before rotation.
...
func defaultEngineConfig() (*EngineConfig, error) {
	...
	storeOpts, err := types2.DefaultStoreOptions()
	if err != nil {
		return nil, err
	}
